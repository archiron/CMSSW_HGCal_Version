...
void ElectronMcFakeValidator::bookHistograms( DQMStore::IBooker & iBooker, edm::Run const &, edm::EventSetup const & )
 {
  ...
  h1_ele_matchingObjectAbsEta_matched = bookH1withSumw2(iBooker, "matchingObjectAbsEta_matched",htitle+"|#eta|",eta_nbin/2,0.,eta_max); //2.5
...
//  h1_recSeedNum_->Fill((*gsfElectronSeeds).size()); // removed for HGCal 2017-09-05

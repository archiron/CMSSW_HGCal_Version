...
void ElectronMcSignalValidator::bookHistograms( DQMStore::IBooker & iBooker, edm::Run const &, edm::EventSetup const & )
 {
  ...
  h1_mc_AbsEta_matched = bookH1withSumw2(iBooker, "AbsEta_matched","Efficiency vs gen |eta|",eta_nbin/2,0.,eta_max);//2.5
...
//  h1_recSeedNum->Fill((*gsfElectronSeeds).size()); // removed for HGCal 2017-09-05
